...
public class HexOrientationTests
{
    ...
    {
        var board = new Board(10, 10, HexTopOrientation.PointyTopped);
        var origin = new CubeCoordinate(0, 0, 0);
        board.AddHex(new Hex(origin));
    ...
    {
        var board = new Board(10, 10, HexTopOrientation.FlatTopped);
        var origin = new CubeCoordinate(0, 0, 0);
        board.AddHex(new Hex(origin));
