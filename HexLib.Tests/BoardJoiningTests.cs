...
public class BoardJoiningTests
{
    ...
    {
        var boardA = new Board(36, 16) { Name = "A", HalfHexSides = BoardEdge.Right };
        var boardB = new Board(36, 16) { Name = "B", HalfHexSides = BoardEdge.Left };
    ...
    {
        var boardA = new Board(36, 16) { Name = "A", HalfHexSides = BoardEdge.Bottom };
        var boardB = new Board(36, 16) { Name = "B", HalfHexSides = BoardEdge.Top };
    ...
    public void CanJoin_MismatchingDimensions_ReturnsFalse()
    {
        ...
        var boardA = new Board(36, 16) { Name = "A", HalfHexSides = BoardEdge.Right };
        var boardB = new Board(36, 15) { Name = "B", HalfHexSides = BoardEdge.Left }; // Height mismatch
    ...
    {
        var boardA = new Board(36, 16) { Name = "A", HalfHexSides = BoardEdge.None }; // Missing Right
        var boardB = new Board(36, 16) { Name = "B", HalfHexSides = BoardEdge.Left };
    ...
    public void Join_AlreadyJoinedEdge_ThrowsException()
    {
        var boardA = new Board(36, 16) { Name = "A", HalfHexSides = BoardEdge.Right };
        var boardB = new Board(36, 16) { Name = "B", HalfHexSides = BoardEdge.Left };
        var boardC = new Board(36, 16) { Name = "C", HalfHexSides = BoardEdge.Left };
    ...
    {
        var boardA = new Board(32, 16) { Name = "A", HalfHexSides = BoardEdge.Right };
        var boardB = new Board(32, 16) { Name = "B", HalfHexSides = BoardEdge.Left };
    ...
    {
        var boardA = new Board(16, 32) { Name = "A", HalfHexSides = BoardEdge.Right };
        ...
        var boardB = new Board(32, 16) { Name = "B", HalfHexSides = BoardEdge.Bottom };
        boardB.Orientation = BoardOrientation.Degree90; 
    ...
    {
        var boardA = new Board(36, 16) { Name = "A", HalfHexSides = BoardEdge.Top };
        var boardB = new Board(36, 16) { Name = "B", HalfHexSides = BoardEdge.Bottom };
