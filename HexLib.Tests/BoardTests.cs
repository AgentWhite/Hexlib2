...
public class BoardTests
{
    ...
    {
        var board = new Board<object, object>(10, 15);
    ...
    {
        var board = new Board<object, object>(10, 10);
    ...
    public void AddHex_DuplicateLocation_ThrowsException()
    {
        ...
        Assert.Throws<ArgumentException>(() => board.AddHex(new Hex<object>(new CubeCoordinate(0, 0, 0))));
    }
    ...
    {
        var board = new Board<object, object>(10, 20);
