...
public struct HexCube
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HexCube"/> struct.
    /// </summary>
    ...
    /// <returns>A new <see cref="HexCube"/> representing the sum of the coordinates.</returns>
    ...
    /// <returns>A new <see cref="HexCube"/> representing the difference between the coordinates.</returns>
    public static HexCube operator -(HexCube a, HexCube b)
    {
        return new HexCube(a.X - b.X, a.Y - b.Y, a.Z - b.Z);
    }
